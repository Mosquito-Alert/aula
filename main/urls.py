...
urlpatterns = [
    ...
    path('uploadpics3', views.uploadpics3, name="uploadpics3"),
    path('uploadfiles3', views.uploadfile, name="uploadfiles3"),
    path('deletepics3', views.uploadpic, name="deletepics3"),
